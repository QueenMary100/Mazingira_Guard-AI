...
## ✨ Key Features
- **🛰️ Satellite Monitoring:** Ingests multispectral imagery for real-time sector analysis and change detection.
- **📂 Incident Registry:** A robust terminal for rangers to manage, verify, and export environmental crime reports.
- **🗺️ Interactive GIS:** Embedded satellite mapping to visualize precise detection coordinates.
- **🎙️ Accessible HQ Terminal:** A multimodal chatbot for field use featuring:
  - **Speech-to-Text (STT):** Hands-free query input for rangers in the field.
  - **Text-to-Speech (TTS):** Professional audio explanations via Gemini 2.5 Flash TTS.
  - **Video Simulations:** Cinematic 4K visualizations of reports using the **Veo** model.

## 🛠️ Tech Stack
- **Framework:** React with TypeScript
- **Styling:** Tailwind CSS (Modern Dark Mode / Emerald Forest Theme)
- **AI Core:**
  - `gemini-3-pro-preview`: For complex reasoning and multimodal vision.
  - `gemini-3-flash-preview`: For high-speed conversational liaison.
  - `gemini-2.5-flash-preview-tts`: For high-fidelity accessible audio output.
  - `veo-3.1-fast-generate-preview`: For cinematic environmental visualizations.
- **Grounding:** Google Search & Google Maps Integration.

## 🛡️ Security & Ethics
- **End-to-End Encryption:** Secured terminal access for verified KWS personnel.
